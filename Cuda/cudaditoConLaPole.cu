...
__global__ void cMax(float *layer, Max *maximosTemp, int layer_size, int i)
{
...
int main(int argc, char *argv[])
{
    ...
    for (i = 0; i < num_storms; i++)
    {
        ...
        cMax<<<gridShapeGpuFunc1, bloqShapeGpuFunc1, bloqShapeGpuFunc1.x * sizeof(Max)>>>(dlayer, dMaximosTemp, layer_size, i);
